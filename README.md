...
contract structure. Built for a Manus v4 hard-evidence regime: every
exported row carries either a real supplier-website citation, a
secondary-listing citation, or a controlled `manual review required`
neutral statement — never category-template prose.
...
agents/
  ...
  final_validator.py          # Hard pre-export quality gate (Manus v4)
...
6. Every Tier-B row uses an allowed v4 basis (`secondary listing`,
...
Manus v4 first-100 live pilot: **PASS** (0 failures, 8/8 gates green).
